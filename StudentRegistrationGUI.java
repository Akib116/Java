...
{   
    ...
    public StudentRegistrationGUI() { 
    	frame = new JFrame("A Student Registration Form by Sadman Shakib Akib");
    ...
    public void initComponents() {
    	...
    	jButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if(jTextField1.getText().equals("")) {
					JOptionPane.showMessageDialog(frame,"Your, Field is empty...","Field empty",JOptionPane.WARNING_MESSAGE);
					...
					JOptionPane.showMessageDialog(frame,"Your, Password & Confirm Password doesn't match yet...","Password Missmatch",JOptionPane.WARNING_MESSAGE);
				}else{
					pwd_Error.setVisible(false); 
					Firstname_Error.setVisible(false);
